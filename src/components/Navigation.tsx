        ...
        <DialogContent className="bunny-card">
          <DialogHeader>
            <DialogTitle className="text-2xl font-bold text-gray-800 dark:text-gray-200">
              ...
              {authMode === 'devkey' && 'Dev Key Recovery'}
            </DialogTitle>
            <DialogDescription className="text-black dark:text-white">
              {authMode === 'signin' && 'Sign in with username/email and password'}
              {authMode === 'signup' && 'Create an account to manage your files'}
              {authMode === 'recover' && 'Enter your username or email to receive a reset link'}
              {authMode === 'devkey' && 'Enter your username and dev key to recover your password'}
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4 mt-4">
            <div>
              <Label htmlFor="username" className="text-black dark:text-white font-semibold">
                {authMode === 'signin' || authMode === 'recover' ? 'Username or Email' : 'Username'}
              </Label>
              <Input
                id="username"
                value={username}
            ...
            >
              {authMode === 'signin' && 'Sign In'}
              {authMode === 'signup' && 'Sign Up'}
              {authMode === 'recover' && (sendingReset ? 'Sending...' : 'Send Reset Link')}
              {authMode === 'devkey' && 'Recover Password'}
            </Button>
