...
function TermsOfService() {
  return (
    <div className="prose prose-pink dark:prose-invert max-w-none">
      <h2 className="text-3xl font-bold text-gray-800 dark:text-gray-200 mb-4">Terms of Service</h2>
      <p className="text-sm text-gray-800 dark:text-gray-200 mb-6">Last Updated: November 25, 2025</p>
...
function PrivacyPolicy() {
  return (
    <div className="prose prose-pink dark:prose-invert max-w-none">
      <h2 className="text-3xl font-bold text-gray-800 dark:text-gray-200 mb-4">Privacy Policy</h2>
      <p className="text-sm text-gray-800 dark:text-gray-200 mb-6">Last Updated: November 25, 2025</p>
...
function AcceptableUsePolicy() {
  return (
    <div className="prose prose-pink dark:prose-invert max-w-none">
      <h2 className="text-3xl font-bold text-gray-800 dark:text-gray-200 mb-4">Acceptable Use Policy</h2>
      <p className="text-sm text-gray-800 dark:text-gray-200 mb-6">Last Updated: November 25, 2025</p>
