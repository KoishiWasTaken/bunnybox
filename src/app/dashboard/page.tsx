      ...
      <div className="max-w-6xl mx-auto p-8">
        ...
        {files.length === 0 ? (
          <Card className="bunny-card p-12 text-center">
            <h2 className="text-2xl font-bold text-black dark:text-white mb-4">No files yet</h2>
            <p className="text-black dark:text-white mb-6">Upload your first file to get started!</p>
            <Link href="/">
